...
<div className="grid w-full">
  ...
  <div className=" md:flex md:items-center">
    ...
    <div className="w-4/5 md:mb-4 sm:mb-10">
      <input className="w-full h-12 px-4 py-2 leading-tight text-gray-400 bg-gray-100 rounded appearance-none focus:border-2 focus:outline-none focus:bg-white focus:border-red-400" 
